...
%     
    ...
    TE_spt_a_list = [TE_spt_a_list TE_spt_a];
    TE_spt_n_list = [TE_spt_n_list TE_spt_n];
...
figure('Name','analytic and numerical eccentricity','NumberTitle','off');
    ...
    subplot(3,1,3)
    plot(orbit_t_list,TE_spt_a_list);hold on;
    plot(orbit_t_list,TE_spt_n_list);
...
figure('Name','exact and numerical solution','NumberTitle','off');
    ...
    plot(orbit_t_list,nu_total_list,'r');
